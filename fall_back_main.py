...
import simulator_with_feedback
...
m_satellite = []
isl_packet_drop_rate = 0.001
gsl_packet_drop_rate = 0.01
satellite_num = 0
...
def run_with_hurry():
    ...
    for i in range(len(m_satellite)+len(m_ground_stations)):
        current_queue_length.append(0)
    while(True):
        print("////////////////////////////")
        print("current_loop_id=",current_loop_id)
        print("////////////////////////////")
        fall_back_percentage=0.9
        generate_length=min(total_sim_time_ns//sim_time_step_ns-current_loop_id,30)
        routing_table,queue_len = sim_with_hurry.sim_with_hurry(total_sim_time_ns,
                                                                sim_time_step_ns,
                                                                m_satellite.copy(),
                                                                m_ground_stations.copy(),
                                                                m_epoch,
        ...
        # return
        # print(throughput_table)
        throughput_table,latency,packet_droped_table,satellite_queue_len,ground_station_queue_len,current_loop_id,fall_back_flag,current_queue_length=simulator_with_feedback.simulator(m_satellite.copy(),
                                                                                                                    m_ground_stations.copy(),
                                                                                                                    isl_packet_drop_rate,
                                                                                                                    gsl_packet_drop_rate,
                                                                                                                    routing_table.copy(),
                                                                                                                    ...
                                                                                                                    isl_max_cap,
                                                                                                                    m_epoch,total_generating_time,
                                                                                                                    fall_back_percentage,queue_len,generate_length,current_loop_id,current_queue_length)
